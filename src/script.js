...
function setup() {
    ...
    function run() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            function makeUl(name, age, cpf) {
                var ul = document.createElement('ul');
                document.body.appendChild(ul);
                ul.innerText = name + " | " + age + " | " + cpf;
                return ul;
            }
            var filePathTxt, customerDataTxt, liTxt, _i, _a, customer, name_3, age, cpf, filePathJson, customerDataJson, liJson, _b, _c, customer, name_4, age, cpf;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        liTxt = makeLi('Arquivo Txt');
                        for (_i = 0, _a = customerDataTxt.custumerData; _i < _a.length; _i++) {
                            customer = _a[_i];
                            name_3 = customer.name, age = customer.age, cpf = customer.cpf;
                            liTxt.appendChild(makeUl(name_3, age, cpf));
                        }
                        console.log('-------------------------------');
                    ...
                    case 2:
                        ...
                        liJson = makeLi('Arquivo Json');
                        for (_b = 0, _c = customerDataJson.custumerData; _b < _c.length; _b++) {
                            customer = _c[_b];
                            name_4 = customer.name, age = customer.age, cpf = customer.cpf;
                            liJson.appendChild(makeUl(name_4, age, cpf));
                        }
                        return [2 /*return*/];
                }
            });
